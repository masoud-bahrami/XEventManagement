...
public class TicketTests
{
    ...
    public void Tickets_WithDuplicateNames_ShouldFail()
    {
        ...
        Action act = () => new Tickets(tickets);
    ...
    {
        var tickets = new Tickets(new List<TicketDto> { new("VIP", 100, 10) });

        var addEvent = new NewEventTicketIsAddedEvent(2, new TicketDto("Standard", 50, 20));
    ...
    {
        var tickets = new Tickets(new List<TicketDto> { new("VIP", 100, 10) });
        var addEvent = new NewEventTicketIsAddedEvent(2, new TicketDto("VIP", 50, 5));
